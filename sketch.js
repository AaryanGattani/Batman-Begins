...
function setup()
{
  ...
  man = createSprite(300,200,55,55)
  ...
  Man=Matter.Bodies.rectangle(300,600,55,55,{isStatic:true});
  Matter.World.add(world,Man);
  if(frameCount % 150 === 0){

    for(var i=0; i<150; i++){
        drops.push(new createDrop(random(0,600), random(0,400)));
    }
...
if(frameCount % 100 == 0)
{
  thunder = createSprite(random(20,380),50)
  thunder.lifetime=20;
